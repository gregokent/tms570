...
impl R {
    ...
    #[doc = "Bit 9 - 1 = Enable Direct Access to RAM in Test Mode"]
    #[inline]
    ...
    #[doc = "Bit 8 - 1 = Enable External Loopback"]
    #[inline]
    ...
    #[doc = "Bit 7 - 0 = CAN Bus is Dominant, 1=Recessive"]
    #[inline]
    pub fn rx(&self) -> RXR {
        let bits = {
            const MASK: bool = true;
    ...
    #[doc = "Bits 5:6 - Control CANTX 0=Normal,1=Sample Pt. Monitor, 2= Drive Dom., 3=Drive Rec."]
    #[inline]
    pub fn tx(&self) -> TXR {
        let bits = {
            const MASK: u8 = 3;
    ...
    #[doc = "Bit 3 - 1 = Silent Mode Enabled"]
    #[inline]
